...
export const WithDisabledItem = () => (
  <>
    <Menu>
      <MenuButton as={Button} variant="solid" size="sm">
        Open menu
      </MenuButton>
      <MenuList>
        <MenuItem isDisabled icon={<SearchIcon />} command="⌥T">
          Search
        </MenuItem>
        <MenuItem icon={<RepeatIcon />}>Undo</MenuItem>
        <MenuItem icon={<TriangleUpIcon />}>Delivery</MenuItem>
        <MenuItem isDisabled icon={<AttachmentIcon />}>
          Unlink
        </MenuItem>
      </MenuList>
    </Menu>
    ...
    <Menu>
      ...
      <MenuList>
        <MenuItem icon={<SearchIcon />} command="⌥T">
          Search
        </MenuItem>
        <MenuItem icon={<RepeatIcon />}>Undo</MenuItem>
        <MenuItem isDisabled icon={<TriangleUpIcon />}>
          Delivery
        </MenuItem>
        <MenuItem icon={<AttachmentIcon />}>Unlink</MenuItem>
      </MenuList>
    </Menu>
  </>
);
