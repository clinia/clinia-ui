...
import { Icon, IconProps, createIcon } from "@clinia-ui/react";

export default {
  title: "Components / Media and Icons / Icon",
};

export const Basic = () => <Icon fontSize="24px" color="primary.main" />;
...
export const CustomIcon = () => (
  <ArrowIcon boxSize="40px" color="primary.main" />
);
